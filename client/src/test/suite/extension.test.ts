...
suite('Extension Test Suite', () => {
	...
	test('Document characters count', async function () {
		return vscode.workspace.getConfiguration('languageServerExample').update('spaceCharsSwitch', true, true, true)
			.then(async function () {
	...
	test('Document characters count without spaces', async function () {
		return vscode.workspace.getConfiguration('languageServerExample').update('spaceCharsSwitch', false, true, true)
			.then(async function () {
